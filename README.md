...
**Project**: hacker-crypto-haven 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: create a crypto tracker app, add a hacker theme to it and cuse coincap as the api fro crypto data 
...
```sh
git clone https://github.com/GPT-Engineer-App/hacker-crypto-haven.git
cd hacker-crypto-haven
npm i
